...
| [`alibaba-developer-rat-2026-07-28.json`](alibaba-developer-rat-2026-07-28.json) | Cross-platform RAT campaign targeting Alibaba developers (18 npm packages: 17 package-wide matches backed by OSV all-version records, plus `fast-transform-pipeline@1.0.1`) | [Socket, 2026-07-28](https://socket.dev/blog/npm-rat-targets-alibaba) |
